...
// const features = [
//   { icon: "📤", title: "Upload PDFs", desc: "Drag and drop any PDF and it's instantly ready to query." },
//   { icon: "🔍", title: "AI-Powered Search", desc: "Semantic vector search finds the right passage, not just keywords." },
//   { icon: "🧠", title: "Semantic Vector Search", desc: "pgvector + embeddings understand meaning, not just words." },
//   { icon: "✅", title: "Accurate Answers", desc: "Answers are grounded strictly in your own uploaded documents." },
//   { icon: "📎", title: "Source Citations", desc: "Every answer shows exactly which document and page it came from." },
//   { icon: "🔒", title: "Private Documents", desc: "Your documents and chats are never visible to any other user." },
// ];

// const steps = [
//   { n: "1", title: "Upload", desc: "Add your PDF documents to your personal library." },
//   { n: "2", title: "Process", desc: "We extract, chunk, and embed the text automatically." },
//   { n: "3", title: "Ask", desc: "Ask any question in plain language." },
//   { n: "4", title: "Retrieve", desc: "The most relevant chunks are found via vector search." },
//   { n: "5", title: "Generate", desc: "An AI answer is generated, grounded in your sources." },
// ];
...
//         <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full bg-brand-50 px-4 py-1.5 text-sm font-medium text-brand-700">
...
//           Upload your PDFs and ask questions in plain language. DocuChat finds the
//           exact passages that answer your question and cites its sources — every
//           document stays private to your account.
//         </p>
//         <div className="mt-10 flex items-center justify-center gap-4">
//           <Link
//             to="/register"
//             className="rounded-lg bg-brand-500 px-6 py-3 text-base font-semibold text-white shadow-sm hover:bg-brand-600"
//           >
//             Get Started — It's Free
//           </Link>
//           <Link
//             to="/login"
//             className="rounded-lg border border-slate-200 px-6 py-3 text-base font-semibold text-slate-700 hover:bg-slate-50"
//           >
//             Login
//           </Link>
//         </div>
...
//       {/* Pricing (UI placeholder — no payment functionality in V1) */}
...
//         <p className="mt-2 text-slate-600">Coming soon — V1 is free while in early access.</p>
//         <div className="mx-auto mt-10 max-w-sm rounded-2xl border-2 border-brand-500 p-8">
//           <p className="text-sm font-semibold uppercase tracking-wide text-brand-600">Early Access</p>
//           <p className="mt-2 text-4xl font-extrabold text-slate-900">Free</p>
...
//           <Link
//             to="/register"
//             className="mt-8 block rounded-lg bg-brand-500 px-6 py-3 text-sm font-semibold text-white hover:bg-brand-600"
//           >
//             Get Started
//           </Link>
//         </div>
...
//         © {new Date().getFullYear()} DocuChat. Built with FastAPI, PostgreSQL + pgvector, and React.
//       </footer>
//     </div>
//   );
// }
